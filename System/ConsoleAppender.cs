...
{
    /// <summary>
    /// Appends logging events to the console. A stupider yet simpler and working version
    /// of <see cref="ColoredConsoleAppender"/>.
    /// </summary>
    /// <remarks>Colors do not work with the VS debugger attached.</remarks>
