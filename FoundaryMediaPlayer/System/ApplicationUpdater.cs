...
namespace FoundaryMediaPlayer
{
    ...
    /// </summary>
    public sealed class ApplicationUpdater : BindableBase, IDisposable
    {
        ...
        public ApplicationUpdater(IApplicationService applicationService, IPlatform platform, IApplicationSettings applicationSettings)
        {
