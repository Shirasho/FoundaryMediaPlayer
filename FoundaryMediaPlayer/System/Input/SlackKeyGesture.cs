...
{
    /// <summary>
    /// A <see cref="KeyGesture"/> that accepts single key inputs.
    /// </summary>
    public class SlackKeyGesture : InputGesture
    {
        //------------------------------------------------------
        //
        //  Constructors
        ...
        public SlackKeyGesture(Key key)
        ...
        /// <param name="key">key</param>
        public SlackKeyGesture(Key key, ModifierKeys modifiers)
        ...
        public SlackKeyGesture(Key key, ModifierKeys modifiers, string displayString)
        ...
        internal SlackKeyGesture(Key key, ModifierKeys modifiers, bool validateGesture)
        ...
        /// <param name="displayString">display string</param>
        /// <param name="validateGesture">If true, throws an exception if the key and modifier are not valid</param>
        private SlackKeyGesture(Key key, ModifierKeys modifiers, string displayString, bool validateGesture)
        {
