...
namespace FoundaryMediaPlayer.Input
{
    ...
    /// </summary>
    public class MergedInputGesture : InputGesture, IEquatable<KeyGesture>, IEquatable<MouseGesture>, IEquatable<MergedInputGesture>
    {
        /// <summary>
        /// The key.
        /// </summary>
        ...
        /// 
        /// </summary>
        public MergedInputGesture(Key key, bool bCanOverride = true, int priority = 0)
        ...
        /// 
        /// </summary>
        public MergedInputGesture(MouseAction mouseAction, bool bCanOverride = true, int priority = 0)
        ...
        /// 
        /// </summary>
        public MergedInputGesture(Key key, ModifierKeys modifiers, bool bCanOverride = true, int priority = 0)
        ...
        /// 
        /// </summary>
        public MergedInputGesture(MouseAction mouseAction, ModifierKeys modifiers, bool bCanOverride = true, int priority = 0)
        ...
        /// 
        /// </summary>
        public MergedInputGesture(MouseWheelDirection mouseWheelDirection, ModifierKeys modifiers, bool bCanOverride = true, int priority = 0)
        ...
        [JsonConstructor]
        private MergedInputGesture(Key key, MouseAction mouseAction, ModifierKeys modifiers, MouseWheelDirection mouseWheelDirection, bool bCanOverride = true, int priority = 0)
        {
            if (!IsDefinedKey(key))
            {
        ...
        {
            return mouseWheelDirection >= MouseWheelDirection.None && mouseWheelDirection <= MouseWheelDirection.Down;
        }
        ...
        /// <inheritdoc />
        public bool Equals(MergedInputGesture other)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals((MergedInputGesture)obj);
        }
